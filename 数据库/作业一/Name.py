...
if __name__ == '__main__':
    print(Name.gen_two_words(split=' ', lowercase=False))
    print(Name.gen_one_word_digit(lowercase=False))
    print(Name.gen_year(1988, 2015))
    print(Name.gen_birthday(westenstyle=True))
    print(Name.gen_two_words(split='', lowercase=True) + gen_year(1988, 2015))
    print(Name.gen_one_gender_word(male=True))