...
def CalcState():
    ...
    s2=(traci.lane.getLastStepVehicleNumber('15_0')+traci.lane.getLastStepVehicleNumber('15_1')+traci.lane.getLastStepVehicleNumber('15_2')   #南北直右
        ...
        +traci.lane.getLastStepVehicleNumber('6_0')+traci.lane.getLastStepVehicleNumber('6_2')+traci.lane.getLastStepVehicleNumber('6_4'))
...
def run(i, number_of_simulation):
    ...
    while step<3600:
        ...
        for t in range(1,4):
            ...
            departed , departed_number , TravelTimeArray , TotalTravelTime , Reward_step = a_step(departed , departed_number , TravelTimeArray , TotalTravelTime , Reward_step)
