...
m_reward_decay=0.9
m_e_greedy_begin=0.1
m_e_greddy_end=0.9
m_explore_time=5000000

class QLearningTable:

    def __init__(self, n_actions, learning_rate=m_learning_rate, reward_decay=m_reward_decay, e_greedy_begin=m_e_greedy_begin, e_greedy_end=m_e_greddy_end, explore_time=m_explore_time):
